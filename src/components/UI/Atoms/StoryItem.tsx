...
const StoryItem: React.FC = () => {
  return (
    <Flex direction="column" mb={0} px={[2, 10, 10, 12]}>
      ...
      {/* 2022 */}
      <motion.div variants={staggerTimelineItemContainer} initial="hidden" animate="show">
        ...
        <motion.div variants={staggerProjectCardItem}>
          <Timeline icon={FaTools}>
            <Text fontSize="large">
              Built my personal Portfolio with <strong>TypeScript</strong> &{" "}
        ...
        <Timeline icon={FaHtml5}>
          <Text fontSize="large">
            Started learning <strong>HTML</strong>, <strong>CSS</strong> &{" "}
            <strong>JavaScript</strong>
          </Text>
        </Timeline>
