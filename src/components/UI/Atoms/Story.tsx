  ...
  return (
    <>
      ...
      <Heading size="md">
        ...
        of people. Love working as a team and respecting every vision provided - that is how we all
        can learn. Also constantly trying to better myself on clean code principles.
      </Heading>
    </>
  );
};
